(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FacebookButton = /** @class */ (function (_super) {
         ...
         */
            function (url) {
                return this._http.get("https://graph.facebook.com?id=" + url).pipe(operators.map(function (res) { return +res.share.share_count; }));
            };
    ...
    var GooglePlusButton = /** @class */ (function (_super) {
        ...
        function GooglePlusButton(_props, _url, _http, _platform, _document, _windowSize, _disableButtonClick) {
            var _this = _super.call(this, _props, _url, _http, _platform, _document, _windowSize, _disableButtonClick) || this;
            _this._props = _props;
            _this._url = _url;
            _this._http = _http;
    ...
    var TumblrButton = /** @class */ (function (_super) {
         ...
         */
            function (url) {
                return this._http.jsonp("https://api.tumblr.com/v2/share/stats?url=" + url, 'callback').pipe(operators.map(function (res) { return +res.response.note_count; }));
            };
        return TumblrButton;
    }(ShareButtonBase));
    ...
    var PinterestButton = /** @class */ (function (_super) {
         ...
         */
            function (url) {
                return this._http.get("https://api.pinterest.com/v1/urls/count.json?url=" + url, { responseType: 'text' }).pipe(operators.map(function (text) { return JSON.parse(text.replace(/^receiveCount\((.*)\)/, '$1')); }), operators.map(function (res) { return +res.count; }));
            };
    ...
    var MixButton = /** @class */ (function (_super) {
        ...
        function MixButton(_props, _url, _http, _platform, _document, _windowSize, _disableButtonClick) {
            var _this = _super.call(this, _props, _url, _http, _platform, _document, _windowSize, _disableButtonClick) || this;
            _this._props = _props;
            _this._url = _url;
            _this._http = _http;
